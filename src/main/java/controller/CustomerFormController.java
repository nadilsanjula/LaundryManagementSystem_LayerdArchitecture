...
public class CustomerFormController {
    ...
    public void btnSaveOnAction(ActionEvent actionEvent) {
        ...
        if (isValead) {
            ...
            try {
                boolean isSaved = customerBO.saveCustomer(new CustomerDTO(customerId, name, email, address, telNum, nic));
    ...
    public void btnUpdateOnAction(ActionEvent actionEvent) {
        ...
        if (isValead) {
            ...
            try {
                isUpdated = customerBO.updateCustomer(new CustomerDTO(customerId, name, email, address, telNum, nic));
                if (isUpdated) {
    ...
    public void btnDeleteOnAction(ActionEvent actionEvent) {
        ...
        try {
            boolean isRemoved = customerBO.removeCustomer(customerId);
