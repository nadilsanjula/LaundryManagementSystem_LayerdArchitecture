...
public class OrderModel {
    ...
    public static boolean update(OrderDTO orderDTO) throws SQLException {
        ...
        return SQLUtil.execute(sql,orderDTO.getPickupDate(),orderDTO.getDeliveryDate(),orderDTO.getAmount(),orderDTO.getCustomerId(),orderDTO.getStaffid(),orderDTO.getOrderId());
    }
