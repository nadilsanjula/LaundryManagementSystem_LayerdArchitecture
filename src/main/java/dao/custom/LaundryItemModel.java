...
public class LaundryItemModel {
    public static boolean save(LaundryItemDTO laundryItemDTO) throws SQLException {
        ...
        boolean isSaved = SQLUtil.execute(sql, laundryItemDTO.getLaundryItemId(),laundryItemDTO.getName(),laundryItemDTO.getQtyAvailable(),laundryItemDTO.getDesc(),laundryItemDTO.getUnitePrice(),laundryItemDTO.getItemId());
        return isSaved;
    }
    ...
    public static boolean update(LaundryItemDTO laundryItemDTO) throws SQLException{
        ...
        return SQLUtil.execute(sql,laundryItemDTO.getName(),laundryItemDTO.getQtyAvailable(),laundryItemDTO.getDesc(),laundryItemDTO.getUnitePrice(),laundryItemDTO.getItemId(),laundryItemDTO.getLaundryItemId());
    }
    ...
    public static boolean remove(String laundryItemId) throws SQLException {
        ...
        return SQLUtil.execute(sql,laundryItemId);
    }
    ...
    public static LaundryItemDTO search(String laundryItemId) throws SQLException {
        ...
        ResultSet resultSet = SQLUtil.execute(sql, laundryItemId);
